<script>
  ...
  onMount(async () => {
    ...
    // await loadScript(`${mypluginurl}/assets/js/sidebar-menu.js`, `sidebar`);
  });
  onDestroy(() => {
    unsub();
  });
...
<header class="main-nav">
  <div class="sidebar-user text-center">
    ...
    ><img
      ...
      src="{mypluginurl}/assets/images/dashboard/1.png"
      alt=""
    />
    ...
    <div class="main-navbar">
      ...
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
          ...
          <li class="dropdown">
            <a
              class="nav-link menu-title {pathname == mylinkurl
                ? `active`
                : ``}"
            ...
            <ul class="nav-submenu menu-content">
              <li>
                <Link to={mylinkurl + "/"}>Default</Link>
              </li>
              <li>
                <Link to={mylinkurl + "/dashboard"}>Dashboard</Link>
              </li>
            </ul>
          </li>
          <li class="dropdown">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="layout" /><span>Page layout</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="folder-plus" /><span>Bonus Ui</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="cloud-drizzle" /><span>Animation</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="bar-chart" /><span>Charts</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="sliders" /><span>Form Controls </span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="package" /><span>Form Widgets</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="layout" /><span>Form layout</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="server" /><span>Bootstrap Tables </span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="database" /><span>Data Tables </span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="hard-drive" /><span>Ex. Data Tables </span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="jsgrid-table.html"
              ><i data-feather="file-text" /><span>Js Grid Table</span></a
            >
          </li>
          <li class="sidebar-main-title">
            <div>
          ...
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="file-manager.html"
              ><i data-feather="git-pull-request" /><span>File manager</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="kanban.html"
              ><i data-feather="monitor" /><span>kanban Board</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="shopping-bag" /><span>Ecommerce</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="message-circle" /><span>Chat</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="bookmark.html"
              ><i data-feather="heart" /><span>Bookmarks</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="contacts.html"
              ><i data-feather="list" /><span>Contacts</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="task.html"
              ><i data-feather="check-square" /><span>Tasks</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="calendar-basic.html"
              ><i data-feather="calendar" /><span>Calender </span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="social-app.html"
              ><i data-feather="zap" /><span>Social App</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="to-do.html"
              ><i data-feather="clock" /><span>To-Do</span></a
            >
          </li>
          <li class="dropdown">
            <a class="nav-link menu-title link-nav" href="search.html"
              ><i data-feather="search" /><span>Search Result</span></a
            >
          </li>
          <li class="sidebar-main-title">
            <div>
          ...
          <li>
            <a class="nav-link menu-title link-nav" href="landing-page.html"
              ><i data-feather="navigation-2" /><span>Landing page</span></a
            >
          </li>
          <li>
            <a class="nav-link menu-title link-nav" href="sample-page.html"
              ><i data-feather="file" /><span>Sample page</span></a
            >
          </li>
          <li class="dropdown">
            <a
              ...
              ><i data-feather="aperture" /><span>Internationalization</span></a
            >
          </li>
          <li class="dropdown">
            <a
              ...
              ><i data-feather="anchor" /><span>Starter kit </span></a
            >
          </li>
          <li class="mega-menu">
            <a class="nav-link menu-title" href="javascript:void(0)"
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="login-bs-validation.html" target="_blank"
                              >Login With validation</a
                            >
                          </li>
                          <li>
                            <a
                              href="login-bs-tt-validation.html"
                              target="_blank">Login with tooltip</a
                            >
                          </li>
                          <li>
                            <a href="login-sa-validation.html" target="_blank"
                              >Login with sweetalert</a
                            >
                          </li>
                          <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="comingsoon-bg-video.html"
                              >Coming with Bg video</a
                            >
                          </li>
                          <li>
                            <a href="comingsoon-bg-img.html"
                              >Coming with Bg Image</a
                            >
                          </li>
                        </ul>
                      </div>
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="user-check" /><span>Job Search</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="git-pull-request" /><span>Editors</span></a
            >
            <ul class="nav-submenu menu-content">
          ...
          <li class="dropdown">
            <a class="nav-link menu-title" href="javascript:void(0)"
              ><i data-feather="database" /><span>Knowledgebase</span></a
            >
            <ul class="nav-submenu menu-content">
