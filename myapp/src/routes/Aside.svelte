      ...
      <ul class="nav nav-tabs nav-tabs-block nav-justified" role="tablist">
        <li class="nav-item">
          <button
            ...
            aria-selected="true"
          >
            <i class="fa fa-fw fa-coffee text-gray opacity-75 me-1" /> Overview
          </button>
        </li>
        <li class="nav-item">
          <button
            ...
            aria-selected="false"
          >
            <i class="fa fa-fw fa-chart-line text-gray opacity-75 me-1" /> Sales
          </button>
        </li>
      </ul>
            ...
            <div class="block-content">
              ...
              <ul class="nav-items mb-0">
                ...
                <li>
                  <a class="text-dark d-flex py-2" href="javascript:void(0)">
                    <div class="flex-shrink-0 me-3 ms-2">
                      <i class="fa fa-fw fa-pencil-alt text-info" />
                    </div>
                    <div class="flex-grow-1 fs-sm">
              ...
              >
                <div class="mb-4">
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label
                      ...
                      for="so-settings-check1">Show your status to all</label
                    >
                  </div>
                </div>
                <div class="mb-4">
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label
                      class="form-check-label fs-sm"
                      for="so-settings-check2">Keep up to date</label
                    >
                  </div>
                </div>
                <div class="mb-4">
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="form-check form-switch">
                      ...
                      <label
                        class="form-check-label fs-sm"
                        for="so-settings-check4">SMS Notifications</label
                      >
                    </div>
                  </div>
                </div>
                <div class="mb-4">
                  ...
                  <div class="form-check form-switch">
                    ...
                    <label
                      class="form-check-label fs-sm"
                      for="so-settings-check5">Enable access</label
                    >
                  </div>
                </div>
              </form>
            ...
            <div class="block-content">
              <ul class="nav-items push">
                ...
                <li>
                  <a class="text-dark d-flex py-2" href="javascript:void(0)">
                    <div class="flex-shrink-0 me-3 ms-2">
                      <i class="fa fa-fw fa-minus text-danger" />
                    </div>
                    <div class="flex-grow-1 fs-sm">
              ...
              <div class="text-center">
                <a
                  ...
                  href="javascript:void(0)"
                >
                  <i class="fa fa-arrow-down opacity-50 me-1" /> Load More..
                </a>
              </div>
              <!-- END More -->
            </div>
