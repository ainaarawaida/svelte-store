...
for(let i = 0 ; i< scripts.length;i++){
    if(scripts[i].src.includes("customizer.js")){
        // const urlSearchParams = new URLSearchParams(scripts[i].src);
        // const params = Object.fromEntries(urlSearchParams.entries());
        const params = new URLSearchParams(scripts[i].src);
...
$(document).ready(function () {
      $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", mypluginurl+"/assets/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', mypluginurl+'/assets/images/logo/logo.png');
